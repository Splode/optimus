                ...
                <div v-for="(n, i) in notifications" :key="`${i}-notification`"
                    ...
                    <div class="mr-3">
                        ...
                        <svg v-if="n.type === 'warn'" version="1.1" id="Layer_1"
                             ...
                             width="24" height="24"
                             xml:space="preserve">
                            <path fill="#F84D53" d="M10.9,0.5c-0.3-0.7-1.4-0.7-1.8,0l-9,17c-0.2,0.3-0.2,0.7,0,1C0.3,18.8,0.6,19,1,19h18c0.4,0,0.7-0.2,0.9-0.5
  ...
  export default {
    ...
    mounted() {
      EventBus.$on('notify', n => {
        this.notifications.push({ msg: n.msg, type: n.type })
        if (!this.isClearing) {
          this.clear()
        }
      })
