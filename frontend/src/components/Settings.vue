<template>
  <section class="bg-gray-800 overflow-y-auto p-10 w-full" id="settings"
           ref="section">
    ...
    <div
      ...
      <div class="flex flex-wrap items-center my-2 px-4 text-gray-100">
        <label for="prefix"
               v-tooltip.right-end="{ content: 'A string to prepend to the converted image filename.' }">Prefix</label>
        <input @change="setConfig"
      ...
      <div class="flex flex-wrap items-center my-2 px-4 text-gray-100">
        <label for="suffix"
               v-tooltip.right-end="{ content: 'A string to append to the converted image filename.' }">Suffix</label>
        <input @change="setConfig"
               class="bg-gray-900 cursor-pointer focus:outline-none hover:text-green mx-4 px-4 py-2 rounded-md ta-color-slow"
               id="suffix"
               maxlength="16"
        ...
        <div class="flex items-center w-full">
          ...
          <div @click="toggleWebpLossless"
            ...
            <transition mode="out-in" name="fade">
              <svg height="24" id="check-icon"
                   style="enable-background:new 0 0 24 24;"
                   v-if="config.webpOpt.lossless" version="1.1"
                   viewBox="0 0 24 24"
                   width="24"
                   x="0px"
    ...
    <div
      ...
      <div class="px-4 text-gray-100 w-1/2">
        <div class="flex items-center w-full">
          <p class="mr-6" title="Specify the image conversion quality."
             v-tooltip.right-end="{ content: tooltips.quality }">
            Quality</p>
          <div class="w-full">
            <vue-slider @change="setConfig"
...
export default {
  ...
  data() {
    return {
      ...
      tooltips: {
        quality: 'Image quality of the converted image where 0 is the lowest and 100 is the highest.'
      }
    }
  },
